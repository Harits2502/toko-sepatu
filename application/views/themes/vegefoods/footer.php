  ...
  <footer class="ftco-footer ftco-section">
    <div class="container">
      ...
      <div class="row mb-5">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Punya Question?</h2>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->PREMIUM BAJUKU STORE <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                      </p>
        </div>
      </div>
    </div>
