...
<section id="home-section" class="hero">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Toko Baju Murmerz</h1>
            <h2 class="subheading mb-4">AGEN PERBAJUAN BERKUALITAS</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Kuy</a></p>
          </div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/slayer.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Toko Baju Murmerz</h1>
            <h2 class="subheading mb-4">Supplier baju trendy dan kekinian</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Kuy</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Kalau barangnya Ada</span>        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Kualitas Ter d'best</h3>
          <span> Baju yang kami jual menggunakan kain ter d'best</span>        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Bantuan Tapi Ga ngejamin Bakal Ngebantu</span>
        </div>
      </div>      
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4">BAJUKU STORE</h2>
      <p>Baju sedikit mahal berkualitas</p>
    </div>
  </div>   		
  </div>
  <div class="container">
